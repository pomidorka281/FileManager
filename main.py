...
15. Изменить конфиг'''  # возможности файлового менеджера
    ...
    def __cat__(self):
        ...
        try:
            ...
            print('Вы пытаетесь прочитать папку. Если хотите узнать содержимое папки, то воспользуйтесь '
    ...
    def __removeFile__(self):
        ...
        try:
            ...
            print('Вы пытаетесь удалить папку. Если хотите удалить папку, то воспользуйтесь '
